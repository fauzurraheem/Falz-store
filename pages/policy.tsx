  ...
  return (
    <div>
      ...
      <div className='mx-6 my-20'>
        ...
        <div  className='mb-14'>
          <h3 className='text-xl font-medium my-3 '>Third Party Privacy Policies</h3>
          <p className='my-3'>
        ...
        <div  className='mb-14'>
          <h3 className='text-xl font-medium my-3 '>CCPA Privacy Rights</h3>
          <p className='my-3'>
