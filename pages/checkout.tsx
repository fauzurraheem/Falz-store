...
const Checkout = () => {
 ...
 const config = {
  ...
  amount: Total *100,
  publicKey: 'pk_test_5e8fb19405d0aeb9965c6ef8fe96d0265d059926',
  };
        ...
        <form onSubmit={Payment}>
          <div className='mb-6'>
            ...
            <div className='grid Sm:grid-cols-2 gap-4'>
              ...
              <div className='grid grid-cols-1 gap-1 text-sm'>
                ...
                <input type="text" name="phone" className='py-3 px-3 rounded-md outline-none focus:border-emerald-500 border hover:border-emerald-500' placeholder='Your phone Number' value={formData.phone} onChange={onMutate}/>
              </div>
              <div className='grid grid-cols-1 gap-1 text-sm'>
                <label htmlFor="lastName" className='text-gray-500'>Last Name</label>
                <input type="text" name="lastName" className='py-3 px-3 rounded-md outline-none focus:border-emerald-500 border hover:border-emerald-500' placeholder='Your address'value={formData.lastName} onChange={onMutate} />
              </div>
              <div className='grid grid-cols-1 gap-1 text-sm'>
                <label htmlFor="email" className='text-gray-500'>Email Address</label>
                <input type="email" name="email" className='py-3 px-3 rounded-md outline-none focus:border-emerald-500 border hover:border-emerald-500' placeholder='your email' value={formData.email} onChange={onMutate}/>
              </div>
          </div>
          <div className='mb-6'>
            ...
            <div className='grid grid-row-3 gap-4'>
              <div className='grid grid-cols-1 gap-1 text-sm'>
                ...
                <input type="text" name="streetAddress" className='py-3 px-3 rounded-md outline-none focus:border-emerald-500 border hover:border-emerald-500' placeholder='123 Boulevard Rd, Beverley Hills' value={formData.streetAddress} onChange={onMutate}/>
              </div>
              <div className='grid Sm:grid-cols-3 gap-4 text-sm'>
                <div className='grid grid-cols-1 gap-1 text-sm'>
                  <label htmlFor="city" className='text-gray-500'>City</label>
                  <input type="text" name="city" className='py-3 px-3 rounded-md outline-none focus:border-emerald-500 border hover:border-emerald-500' placeholder='Los Angeles' value={formData.city} onChange={onMutate}/>
                </div>
                <div className='grid grid-cols-1 gap-1 text-sm'>
                  <label htmlFor="contry" className='text-gray-500'>Country</label>
                  <input type="text" name="country" className='py-3 px-3 rounded-md outline-none focus:border-emerald-500 border hover:border-emerald-500' placeholder='United States' value={formData.country} onChange={onMutate}/>
                </div>
                <div className='grid grid-cols-1 gap-1 text-sm'>
                  <label htmlFor="zip" className='text-gray-500'>Zip/Postal</label>
                  <input type="text" name="postal" className='py-3 px-3 rounded-md outline-none focus:border-emerald-500 border hover:border-emerald-500' placeholder='2345' value={formData.postal} onChange={onMutate}/>
                </div>
              </div>
              <div>
          ...
          <div>
            <div className='grid Sm:grid-cols-2 gap-4 text-xs'>
              ...
              : 
                <button type='submit' className='flex text-sm  items-center justify-center py-3 bg-emerald-500 hover:bg-emerald-600  rounded-md text-white cursor-pointer' >
                <p className='m-0 ml-2' onClick={Payment}>Confirm</p>
