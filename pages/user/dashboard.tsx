      ...
      <div className=' rounded-lg lg:w-3/4 bg-white p-6 my-6 mx-6 sticky top-60 lg:top-32'>
        ...
        <div className='py-6 grid sm:grid-cols-2 gap-8'>
          <div className='rounded-xl  p-4 border border-gray-200 flex'>
            <div className='rounded-full p-3 bg-red-200 text-red-600'>
          ...
          <div className='rounded-xl  p-4 border border-gray-200 flex'>
            <div className='rounded-full p-3 bg-orange-200 text-orange-600'>
              <FcProcess size={30}/>
            </div>
            <div className='mx-6'>
          ...
          <div className='rounded-xl  p-4 border border-gray-200 flex'>
            <div className='rounded-full p-3 bg-indigo-200 text-indigo-600'>
          ...
          <div className='rounded-xl  p-4 border border-gray-200 flex'>
            <div className='rounded-full p-3 bg-emerald-200 text-emerald-600'>
              <GiCheckMark size={30}/>
            </div>
            <div className='mx-6'>
