  ...
  return (
    <div>
      <div className='mb-20 lg:mb-0 h-2/4 w-full bottom-0' >
        <div className='flex justify-evenly h-[35%] py-10 px-6  bg-indigo-50	'>
          <div className='hidden sm:block'>
          <Image src={shop2} width={900} height={900} />
          </div>
          ...
          <div className='hidden  lg:block'>
            <Image src={shop1} width={900} height={900} />
          </div>
        </div>
        ...
        <div className='h-[45%] pt-10 px-12' >
          <div className=' grid lg:grid-cols-4 grid-cols-2 sm:grid-cols-3 gap-7	text-[0.9rem] mb-8'>
            <div>
            ...
            <div>
              ...
              <ul className='font-light'>
                <div className='flex'>
                  <div className='my-2 '>
                    <FaShoppingBag  color='rgb(21 ,128 ,61)'size={30}/>
                  </div>
                  <div className='flex flex-col justify-center' >
                    <span className='text-[1.2rem]  tracking-[0.3rem] font-[600]	leading-4 text-slate-600'>KACHA</span>
                    <span className='text-[.9rem] tracking-[0.5rem] font-medium leading-3 text-slate-600		'>BAZAR</span>
                  </div>
                </div>
